...
import { addExperience, getCurrentExperience } from '../../actions/profileActions';
...
class AddExperience extends Component {
     ...
     componentWillReceiveProps(nextProps) {
          ...
          if(nextProps.profile.experience) {
               ...
               experience.location = !isEmpty(experience.location) ? experience.location : '';
               experience.from = !isEmpty(experience.from) ? experience.from : '';
               experience.to = !isEmpty(experience.to) ? experience.to : '';
               experience.current = !isEmpty(experience.current) ? experience.current : '';
                                   ...
                                   <form onSubmit={this.onSubmit}>
                                        ...
                                        <div className="form-check mb-4">
                                             <input
                                                  ...
                                                  id="current"
                                             />
                                             <label htmlFor="current" className="form-check-label">Current Job
                  </label>
                                        </div>
                                        <TextAreaFieldGroup
...
export default connect(mapStateToProps, { addExperience, getCurrentExperience })(
